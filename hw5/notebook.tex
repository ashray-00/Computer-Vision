...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
hierarchical\_clustering running time: 65.358798 seconds.
...
{\color{incolor}In [{\color{incolor}7}]:} \PY{k+kn}{from} \PY{n+nn}{segmentation} \PY{k}{import} \PY{n}{color\PYZus{}features}
        ...
        \PY{n}{segments} \PY{o}{=} \PY{n}{segments}\PY{o}{.}\PY{n}{astype}\PY{p}{(}\PY{n+nb}{int}\PY{p}{)}
...
(up to 1 point).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k+kn}{from} \PY{n+nn}{segmentation} \PY{k}{import} \PY{n}{my\PYZus{}features}
...
\texttt{segmentation.py}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{k+kn}{from} \PY{n+nn}{segmentation} \PY{k}{import} \PY{n}{compute\PYZus{}accuracy}
...
segmentation parameters.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{k+kn}{from} \PY{n+nn}{utils} \PY{k}{import} \PY{n}{load\PYZus{}dataset}\PY{p}{,} \PY{n}{compute\PYZus{}segmentation}
...
Mean accuracy: 0.7871
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{} Visualize segmentation results}
