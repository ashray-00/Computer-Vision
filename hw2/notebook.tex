...
\hypertarget{commutative-property-10-points}{%
...
commutative: \(f*h = h*f\)).
    ...
    \textbf{Your Answer:} \emph{Write your solution in this markdown cell.
Please write your equations in
\href{http://jupyter-notebook.readthedocs.io/en/latest/examples/Notebook/Typesetting\%20Equations.html}{LaTex
equations}.} \[
(f * h)[m,n] = \sum_{i=-\infty}^{\infty} \sum_{j=-\infty}^{\infty} f[i,j].h[m-i,n-j]
\] Let: \[
m - i = a \:\: i \rightarrow \infty \:\: \Rightarrow \:\: a \rightarrow -\infty
\] \[
n - j = b \:\: j \rightarrow \infty \:\: \Rightarrow \:\: b \rightarrow -\infty\\
\] Now, \[
\sum_{a=-\infty}^{\infty} \sum_{b=-\infty}^{\infty} f[m-a,n-b].h[a,b]\\
\] Here, a and b are dummy variables. So, replacing them by i and j, we
get \[
\sum_{i=-\infty}^{\infty} \sum_{j=-\infty}^{\infty} f[m-i,n-j].h[i,j]\\
=R.H.S\\
\]
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
/home/ashray/Documents/cv/hw2/.env/lib/python3.7/site-packages/skimage/io/\_io.py:48: UserWarning: `as\_grey` has been deprecated in favor of `as\_gray`
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
conv\_nested: took 0.877566 seconds.
conv\_fast: took 0.505326 seconds.
...
The detected location is not correct. Since we did not take the mean
value of the template into account.
...
F = F_1 + F_2\\
And\:, I * F = (I * F_1) * F_2\\
Since,\:multiplying\:with\:a\:identity\:matrix\:gives\:you\:F.\\
We\:have
I * F = F\\
So,\\
F &= (I * F_1)*F_2\\
