...
\]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} YOUR CODE HERE}
        \PY{k}{pass}
        ...
        \PY{n}{b} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{]}\PY{p}{]}\PY{p}{)}
...
calls below).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{} Let\PYZsq{}s first only get the first singular value and print it out. It should be \PYZti{} 25.46.}
...
\]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{} Let\PYZsq{}s define M.}
...
\texttt{imageManip.py}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{} Run this code to set the locations of the images we will be using. }
...
visualize our work.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{n}{image1} \PY{o}{=} \PY{n}{load}\PY{p}{(}\PY{n}{image1\PYZus{}path}\PY{p}{)}
...
\end{Verbatim}
    ...
    \hypertarget{question-2.2-10-points}{%
...
values and therefore make the image dimmer.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{new\PYZus{}image} \PY{o}{=} \PY{n}{dim\PYZus{}image}\PY{p}{(}\PY{n}{image1}\PY{p}{)}
...
grey scale.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{grey\PYZus{}image} \PY{o}{=} \PY{n}{convert\PYZus{}to\PYZus{}grey\PYZus{}scale}\PY{p}{(}\PY{n}{image1}\PY{p}{)}
...
excluding the specified channel.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{n}{without\PYZus{}red} \PY{o}{=} \PY{n}{rgb\PYZus{}exclusion}\PY{p}{(}\PY{n}{image1}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{R}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
Below is the image without the blue channel.
    ...
    \hypertarget{question-2.5-10-points}{%
...
the specified channel.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{n}{image\PYZus{}h} \PY{o}{=} \PY{n}{hsv\PYZus{}decomposition}\PY{p}{(}\PY{n}{image1}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{H}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
V determines the brightness or intensity of the color of the image. So,
removing H and V shows the intensity or brighness of the color.

    \hypertarget{question-2.6-10-points}{%
...
the right half of the house image with no green channel.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{n}{image\PYZus{}mixed} \PY{o}{=} \PY{n}{mix\PYZus{}images}\PY{p}{(}\PY{n}{image1}\PY{p}{,} \PY{n}{image2}\PY{p}{,} \PY{n}{channel1}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{R}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{channel2}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{G}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}15}]:} 76421.98431372548
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{n}{image\PYZus{}quad} \PY{o}{=} \PY{n}{mix\PYZus{}quadrants}\PY{p}{(}\PY{n}{image1}\PY{p}{)}
         \PY{n}{display}\PY{p}{(}\PY{n}{image\PYZus{}quad}\PY{p}{)}
\end{Verbatim}
