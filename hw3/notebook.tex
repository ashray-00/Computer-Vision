...
the code below.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{k+kn}{from} \PY{n+nn}{edge} \PY{k}{import} \PY{n}{conv}\PY{p}{,} \PY{n}{gaussian\PYZus{}kernel}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{} Test with different kernel\PYZus{}size and sigma}
        \PY{n}{kernel\PYZus{}size} \PY{o}{=} \PY{l+m+mi}{5}
        \PY{n}{sigma} \PY{o}{=} \PY{l+m+mf}{1.4}
        
        \PY{c+c1}{\PYZsh{} Load image}
        \PY{n}{img} \PY{o}{=} \PY{n}{io}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{iguana.png}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{as\PYZus{}grey}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
\emph{-Hint: Remeber that convolution flips the kernel.}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{k+kn}{from} \PY{n+nn}{edge} \PY{k}{import} \PY{n}{partial\PYZus{}x}\PY{p}{,} \PY{n}{partial\PYZus{}y}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{} Compute partial derivatives of smoothed image}
...
an image and outputs \(G\) and \(\Theta\).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{k+kn}{from} \PY{n+nn}{edge} \PY{k}{import} \PY{n}{gradient}
...
image, you should check your implementation.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{k+kn}{from} \PY{n+nn}{edge} \PY{k}{import} \PY{n}{non\PYZus{}maximum\PYZus{}suppression}
...
[[0.4 0.5 0.6]
 ...
 [0.  0.  0.6]]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{nms} \PY{o}{=} \PY{n}{non\PYZus{}maximum\PYZus{}suppression}\PY{p}{(}\PY{n}{G}\PY{p}{,} \PY{n}{theta}\PY{p}{)}
...
Implement \textbf{\texttt{double\_thresholding}} in \texttt{edge.py}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{k+kn}{from} \PY{n+nn}{edge} \PY{k}{import} \PY{n}{double\PYZus{}thresholding}
...
image, you should check your implementation.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{k+kn}{from} \PY{n+nn}{edge} \PY{k}{import} \PY{n}{get\PYZus{}neighbors}\PY{p}{,} \PY{n}{link\PYZus{}edges}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{edges} \PY{o}{=} \PY{n}{link\PYZus{}edges}\PY{p}{(}\PY{n}{strong\PYZus{}edges}\PY{p}{,} \PY{n}{weak\PYZus{}edges}\PY{p}{)}
...
image, you should check your implementation.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{k+kn}{from} \PY{n+nn}{edge} \PY{k}{import} \PY{n}{canny}
...
detect edges from the image.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{k+kn}{from} \PY{n+nn}{edge} \PY{k}{import} \PY{n}{canny}
         
         \PY{c+c1}{\PYZsh{} Load image}
         \PY{n}{img} \PY{o}{=} \PY{n}{io}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{road.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{as\PYZus{}grey}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
edges within the region.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{n}{H}\PY{p}{,} \PY{n}{W} \PY{o}{=} \PY{n}{img}\PY{o}{.}\PY{n}{shape}
...
Implement \textbf{\texttt{hough\_transform}} in \texttt{edge.py}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{k+kn}{from} \PY{n+nn}{edge} \PY{k}{import} \PY{n}{hough\PYZus{}transform}
